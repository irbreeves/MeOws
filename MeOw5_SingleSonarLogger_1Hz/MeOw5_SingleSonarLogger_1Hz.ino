...
//#define FILE_NAME "MeOw5_091621_DataLog.txt"
#define FILE_NAME "DataLog5.txt"  //NOTE: this cannot have underscores
...
int SonarRead() 
{
  ...
  sonarSerial.begin(9600);  // added by KA
  delay(100);
